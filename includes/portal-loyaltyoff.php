...
function casanova_mulligans_tiers(): array {
  return [
    'birdie'    => [ 'min' => 0,      'max' => 9999.99,  'mult' => 1.00, 'label' => 'Birdie' ],
    'eagle'     => [ 'min' => 10000,  'max' => 29999.99, 'mult' => 1.25, 'label' => 'Eagle' ],
...
add_shortcode('casanova_mulligans', function ($atts) {
  ...
  $tier = in_array($tier, ['birdie','eagle','albatross'], true) ? $tier : 'birdie';
